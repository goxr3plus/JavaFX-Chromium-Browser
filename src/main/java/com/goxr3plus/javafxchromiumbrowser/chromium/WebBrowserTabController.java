 ...
 * 
 */
package main.java.com.goxr3plus.javafxchromiumbrowser.chromium;
...
import main.java.com.goxr3plus.javafxchromiumbrowser.application.Main;
import main.java.com.goxr3plus.javafxchromiumbrowser.chromium.services.ChromiumUpdaterService;
import main.java.com.goxr3plus.javafxchromiumbrowser.tools.InfoTool;
import main.java.com.goxr3plus.javafxchromiumbrowser.tools.JavaFXTools;
...
public class WebBrowserTabController extends StackPane {
	 ...
	 * @param firstWebSite
	 */
	public WebBrowserTabController(WebBrowserController webBrowserController, Tab tab, String firstWebSite, Stage window) {
	...
	private void initialize() {
		...
		try {
			...
			about.setOnAction(a -> JavaFXTools.createAlert("Browser Information", null, "Browser Version :" + WebBrowserController.VERSION + "\n" + "Created by: GOXR3PLUS STUDIO",
					AlertType.INFORMATION, StageStyle.UTILITY, window, null).showAndWait());
	...
	private class MyContextMenuHandler implements ContextMenuHandler {
		...
		private void createAndDisplayContextMenu(final ContextMenuParams params) {
			...
			if (!params.getLinkText().isEmpty())
				contextMenu.getItems().add(createMenuItem("Open link in new Tab", () -> webBrowserController.addNewTabOnTheEnd(params.getLinkURL())));
			...
			contextMenu.show(window, screenLocation.getX(), screenLocation.getY());
		}
